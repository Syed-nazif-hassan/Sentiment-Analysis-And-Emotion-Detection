# Sentiment Analysis and Emotion Detection for Business-H

## This project analyzes opinions about a fictional company, Business-H, using transformers for both sentiment analysis and emotion detection. The implementation is done in Python.
